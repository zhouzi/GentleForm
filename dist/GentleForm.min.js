...
!function(t,e){"object"==typeof exports&&"object"==typeof module?module.exports=e():"function"==typeof define&&define.amd?define([],e):"object"==typeof exports?exports.GentleForm=e():t.GentleForm=e()}(this,function(){return function(t){function e(n){if(r[n])return r[n].exports;var i=r[n]={exports:{},id:n,loaded:!1};return t[n].call(i.exports,i,i.exports,e),i.loaded=!0,i.exports}var r={};return e.m=t,e.c=r,e.p="",e(0)}([/*!***************************!*\
  !*** ./src/GentleForm.js ***!
  \***************************/
function(t,e,r){"use strict";function n(t){function e(){n(t,"submitted",!0),c(t),o().forEach(c);for(var e=arguments.length,r=Array(e),i=0;e>i;i++)r[i]=arguments[i];v.apply(b,r)}function r(){o().forEach(s)}function n(t,e,r){var n=t.getAttribute("name"),i=u('[data-states-for="'+n+'"]'),a=[t].concat(i),o="is-"+e;r?a.forEach(function(t){return t.classList.add(o)}):a.forEach(function(t){return t.classList.remove(o)})}function a(t,e){var r="is-"+e;return t.classList.contains(r)}function u(e){return[].slice.call(t.querySelectorAll(e))}function o(){return u("input").filter(function(t){var e=t.getAttribute("name"),r=["button","submit","reset","file"];return-1===r.indexOf(e)}).concat(u("textarea, select"))}function c(t){t.checkValidity()?(n(t,"valid",!0),n(t,"invalid",!1)):(n(t,"valid",!1),n(t,"invalid",!0)),s(t)}function s(t){var e=t.getAttribute("name"),r=t.validity,n=function(t){if("valid"===t)return"continue";var n=r[t]===!1,i=u('[data-errors-for="'+e+'"] [data-errors-when="'+t+'"]');i.forEach(function(t){n?d(t):f(t)})};for(var i in r){n(i)}}function f(t){t.style.display="",t.removeAttribute("aria-hidden")}function d(t){t.style.display="none",t.setAttribute("aria-hidden","true")}function l(){u("[data-include]").forEach(function(t){var e=t.getAttribute("data-include");null==m[e]&&(m[e]=document.getElementById(e).innerHTML),t.innerHTML=m[e]})}function p(){u("[required], [aria-required]").forEach(function(t){t.hasAttribute("required")?t.setAttribute("aria-required","true"):t.removeAttribute("aria-required")}),u("[data-errors-for]").forEach(function(t){t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive"),t.setAttribute("aria-atomic","true");var e=t.getAttribute("id");e||(e="gentle_"+i++,t.setAttribute("id",e));var r=t.getAttribute("data-errors-for"),n=u('[name="'+r+'"]')[0],a=n.getAttribute("aria-describedby")||"",o=a.split(" ");-1===o.indexOf(e)&&o.push(e),n.setAttribute("aria-describedby",o.join(" ").trim())})}var v=arguments.length<=1||void 0===arguments[1]?function(){}:arguments[1],b={onSubmit:e,updateMessages:r,updateIncludes:l,refreshAria:p,isValid:t.checkValidity.bind(t)},m={};return t.addEventListener("submit",e,!1),t.addEventListener("change",function(t){var e=t.target;n(e,"changed",!0),c(e)},!1),t.addEventListener("input",function(e){var r=e.target;(a(r,"changed")||a(t,"submitted"))&&c(r)},!1),l(),u("[data-errors-when]").forEach(d),p(),b}r(1);var i=0;t.exports=n},/*!***************************************************!*\
