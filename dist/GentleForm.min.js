	    ...
	    _createClass(GentleForm, [{
	        ...
	        value: function validate($elements) {
	            ...
	            $elements.each(function (element) {
	                ...
	                if ($element.isValid()) $element.setState('invalid', false, self.$form);else if (tag != 'form' || validateForm) $element.setState('invalid', true, self.$form);
	...
	var $ = (function () {
	    ...
	    _createClass($, [{
	        ...
	        value: function setState(stateName, stateValue) {
	            var parentForm = arguments.length <= 2 || arguments[2] === undefined ? document : arguments[2];
	            ...
	            var $reflectors = new $('[data-gentle-state-for="' + this.getAttr('name') + '"]', parentForm);
